...
const EchoVectorGate = lazy(() => import("./games/echo-vector/EchoVectorGate"));
...
export function App() {
  ...
  return (
    <div className="site-shell">
      ...
      {activeGame === "echo-vector" && (
        <Suspense fallback={<div className="gate-loading" role="status"><span />Loading temporal chamber…</div>}>
          <EchoVectorGate onExit={() => setActiveGame(null)} />
        </Suspense>
      )}
    </div>
  );
